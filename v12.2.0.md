...
For enhanced performance, the `FastCloningStrategy` can be used. It clones plain objects with the spread operator `...`, which has two trade-offs:

1. It skips non-enumerable properties.
2. It turns computed properties into regular ones.
...
// This property won't exist on the clone.
...
Object.defineProperty(obj, 'fullName', {
  get() => `${obj.firstName} ${obj.lastName}`,
  enumerable: true,
})

const clone = _.cloneDeep(obj, _.FastCloningStrategy)
```
