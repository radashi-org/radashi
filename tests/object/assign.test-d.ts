...
describe('assign types', () => {
  ...
  test('should return merged types', ()=> {
    ...
    expectTypeOf(obj).toMatchTypeOf<{ a: number; b: string; c: boolean, d: number; e: string }>()
  })
  ...
  test('should return merged types with nested objects', ()=> {
    ...
    expectTypeOf(obj).toEqualTypeOf<{ a: { b: string, c: string }, d: string }>()
  })
  ...
  test("should override types", ()=> {
    ...
    expectTypeOf(obj).toEqualTypeOf<{ a: boolean; b: number; c: { d: number } }>()
  })
})
